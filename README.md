...
# links the new collection to the master collection using the bpy.context.scene.collection.children.link() method (the new collection will be visible in the Outliner and can be used to organize objects in the scene)
